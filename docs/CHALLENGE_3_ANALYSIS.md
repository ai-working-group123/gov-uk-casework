...
The challenge says "caseworkers across government." Your prototype uses visa/immigration — good call, universally understood. But to impress judges, you need to show you *understand the pattern* across government, not just one silo. This document gives you the domain knowledge to seed realistic data and defend your design choices.
...
*Source: GOV.UK — "Change vehicle details on a V5C registration certificate (log book)" and all linked guidance pages.*
